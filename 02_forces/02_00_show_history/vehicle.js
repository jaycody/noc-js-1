...
function Vehicle() {
  ...
  this.perlinForceRange     = createVector(30,30);  //(3,3)
  this.perlinForceIncrement = createVector(.3,.3); //(.03, .03)
...
/////////////////////////////////////////////
  ...
  this.display      = function(){
    ...
    for (var i = 0; i < this.history.length; i++){
      ...
      // use the previousLocation vector to draw a new ellipse
      fill(random(255));
      ellipse(previousLocation.x, previousLocation.y, this.diameter/2, this.diameter/2);
      //ellipse(previousLocation.x, previousLocation.y, i*.8, i*.8);
    }
  };
